...
**需要 Python 3.13+。** 如果装的时候报 `Could not find a version that satisfies the requirement`，说明你的 Python 版本太低。先升级 Python，或者跑一下 `pip install --upgrade pip` 能看到更清楚的报错信息。
